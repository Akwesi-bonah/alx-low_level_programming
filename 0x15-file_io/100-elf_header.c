 ...
 * @e_ident: Pointer to the array containing the ELF magic numbers
 *
 * Description: if fail exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_class - Prints the classes of the ELF header
 ...
 * @e_ident: Piointer to the array containing the ELF version
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
